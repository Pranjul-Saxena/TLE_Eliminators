...
const StudentProfile = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("studentRes___>>>>", studentRes.data);
        ...
        setRatingHistory(contestsRes.data.ratingChart || []);

        console.log("contestsRes", contestsRes.data.contestList);
        console.log("ratingChart", contestsRes.data.ratingChart);
  ...
  const getFilteredRatingHistory = () => {
    ...
    return ratingHistory.filter((data) => {
      const contestDate = new Date(data.x);
          ...
          <Card className="bg-white dark:bg-slate-800 transition-colors duration-300">
            ...
            <CardContent>
              {loading.contests ? (
                ...
                <ContestChart ratingData={getFilteredRatingHistory()} />
              )}
            </CardContent>
          </Card>
